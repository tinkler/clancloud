...
class Permission {
	...
	Future<void> savePermission(
		...
		var response = await D.instance.dio.post('/permission/permission/save-permission', data: {
			"data": this,
			"args": {  }
		});
	...
	Future<void> deletePermission(
		...
		var response = await D.instance.dio.post('/permission/permission/delete-permission', data: {
			"data": this,
			"args": {  }
		});
		if (response.data['code'] == 0) {
...
class RolePermission {
	...
	Future<void> savePermission(
		...
		var response = await D.instance.dio.post('/permission/role_permission/save-permission', data: {
			"data": this,
			"args": {  }
		});
		if (response.data['code'] == 0) {
	...
	Future<void> deletePermission(
		...
		var response = await D.instance.dio.post('/permission/role_permission/delete-permission', data: {
			"data": this,
			"args": {  }
		});
		if (response.data['code'] == 0) {
...
class UserPermission {
	...
	Future<void> savePermission(
		...
		var response = await D.instance.dio.post('/permission/user_permission/save-permission', data: {
			"data": this,
			"args": {  }
		});
		if (response.data['code'] == 0) {
	...
	Future<void> deletePermission(
		...
		var response = await D.instance.dio.post('/permission/user_permission/delete-permission', data: {
			"data": this,
			"args": {  }
		});
		if (response.data['code'] == 0) {
