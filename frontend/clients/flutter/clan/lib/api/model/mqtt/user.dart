...
class UserProfile {
  ...
  Future<void> save() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/user/user_profile/save',
        data: {"data": this, "args": {}});
...
class UserRole {
  ...
  Future<void> save() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/user/user_role/save',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
...
class User {
  ...
  Future<void> save() async {
    var response = await D.instance.dio.post('$modelUrlPrefix/user/user/save',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
  ...
  Future<void> addRole(
    ...
    var response =
        await D.instance.dio.post('$modelUrlPrefix/user/user/add-role', data: {
      "data": this,
      "args": {
        "role": role,
      }
  ...
  Future<void> get() async {
    var response = await D.instance.dio.post('$modelUrlPrefix/user/user/get',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = User.fromJson(response.data['data']['data']);
      assign(respModel);
  ...
  Future<void> getRoles() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/user/user/get-roles',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = User.fromJson(response.data['data']['data']);
      assign(respModel);
...
class Auth {
  ...
  Future<Auth?> signin() async {
    var response = await D.instance.dio.post('$modelUrlPrefix/user/auth/signin',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
  ...
  Future<void> quickSignin() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/user/auth/quick-signin',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = Auth.fromJson(response.data['data']['data']);
      assign(respModel);
  ...
  Future<Auth?> signup() async {
    var response = await D.instance.dio.post('$modelUrlPrefix/user/auth/signup',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = Auth.fromJson(response.data['data']['data']);
      assign(respModel);
