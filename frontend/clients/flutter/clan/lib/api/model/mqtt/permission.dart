...
class Permission {
  ...
  Future<void> savePermission() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/permission/permission/save-permission',
        data: {"data": this, "args": {}});
  ...
  Future<void> deletePermission() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/permission/permission/delete-permission',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = Permission.fromJson(response.data['data']['data']);
      assign(respModel);
...
class RolePermission {
  ...
  Future<void> savePermission() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/permission/role_permission/save-permission',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
  ...
  Future<void> deletePermission() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/permission/role_permission/delete-permission',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = RolePermission.fromJson(response.data['data']['data']);
      assign(respModel);
...
class UserPermission {
  ...
  Future<void> savePermission() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/permission/user_permission/save-permission',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
  ...
  Future<void> deletePermission() async {
    var response = await D.instance.dio.post(
        '$modelUrlPrefix/permission/user_permission/delete-permission',
        data: {"data": this, "args": {}});
    if (response.data['code'] == 0) {
      var respModel = UserPermission.fromJson(response.data['data']['data']);
      assign(respModel);
  ...
  UserPermission.fromJson(Map<String, dynamic> json) {
    ...
    user =
        json["user"] == null ? $user.User() : $user.User.fromJson(json["user"]);
